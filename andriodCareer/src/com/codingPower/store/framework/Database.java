...
public class Database {
    ...
    public boolean avaible() {
        ...
        File fdb = new File(dataRootPath + System.getProperty("file.separator") + SYSTEM_DIRECTORY_DATA_DATABASES + "/" + DATABASE_NAME);
        try {
            if (!fdb.exists()) {
                new File(dataRootPath + System.getProperty("file.separator") + SYSTEM_DIRECTORY_DATA_DATABASES + "/").mkdir();
                fdb.createNewFile();
            }
