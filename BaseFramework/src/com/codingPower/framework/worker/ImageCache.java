...
import com.codingPower.framework.util.ActivityUtil;
...
public class ImageCache {
    ...
    private void init(ImageCacheParams cacheParams) {
        ...
        if (mCacheParams.memoryCacheEnabled) {
            LogUtil.d(ImageCache.class, "Memory cache created (size = " + mCacheParams.memCacheSize + ")");
                ...
                if (mCacheParams.diskCacheEnabled && diskCacheDir != null) {
                    ...
                    if (getUsableSpace(diskCacheDir) > mCacheParams.diskCacheSize) {
                        try {
                            ...
                            LogUtil.d(ImageCache.class, "Disk cache initialized");
                        } catch (final IOException e) {
                            mCacheParams.diskCacheDir = null;
                            LogUtil.e(ImageCache.class, "initDiskCache - " + e);
                        }
                    }
                }
            }
        ...
        synchronized (mDiskCacheLock) {
            ...
            if (mDiskLruCache != null) {
                ...
                try {
                    ...
                    LogUtil.e(ImageCache.class, "addBitmapToCache - " + e);
                } catch (Exception e) {
                    LogUtil.e(ImageCache.class, "addBitmapToCache - " + e);
                } finally {
                    try {
    ...
    public Bitmap getBitmapFromMemCache(String data) {
        if (mMemoryCache != null) {
            ...
            if (memBitmap != null) {
                ...
                LogUtil.d(ImageCache.class, "Memory cache hit");
                return memBitmap;
            }
        }
        return null;
            ...
            if (mDiskLruCache != null) {
                ...
                try {
                    ...
                    if (snapshot != null) {
                        ...
                        LogUtil.d(ImageCache.class, "Disk cache hit");
                    ...
                    LogUtil.e(ImageCache.class, "getBitmapFromDiskCache - " + e);
                } finally {
                    try {
                        if (inputStream != null) {
                            inputStream.close();
    ...
    public void clearCache() {
        if (mMemoryCache != null) {
            ...
            LogUtil.d(ImageCache.class, "Memory cache cleared");
        }
        ...
        synchronized (mDiskCacheLock) {
            ...
            if (mDiskLruCache != null && !mDiskLruCache.isClosed()) {
                try {
                    ...
                    LogUtil.d(ImageCache.class, "Disk cache cleared");

                } catch (IOException e) {
                    LogUtil.e(ImageCache.class, "clearCache - " + e);
                }
                mDiskLruCache = null;
                initDiskCache();
            }
    ...
    public void flush() {
        synchronized (mDiskCacheLock) {
            if (mDiskLruCache != null) {
                try {
                    mDiskLruCache.flush();
                    LogUtil.d(ImageCache.class, "Disk cache flushed");

                } catch (IOException e) {
                    LogUtil.e(ImageCache.class, "flush - " + e);
                }
            }
        }
    }
            ...
            if (mDiskLruCache != null) {
                try {
                    if (!mDiskLruCache.isClosed()) {
                        mDiskLruCache.close();
                        mDiskLruCache = null;
                        LogUtil.d(ImageCache.class, "Disk cache closed");

                    }
                } catch (IOException e) {
                    LogUtil.e(ImageCache.class, "close - " + e);
                }
            }
        }
    }
    ...
    public static class RetainFragment extends Fragment {
        ...
        /**
         * Store a single object in this Fragment.SS
         *
